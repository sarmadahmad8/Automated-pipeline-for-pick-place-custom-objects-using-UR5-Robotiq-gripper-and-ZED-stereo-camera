    ...
    MoveGroupReceiver() : Node("move_group_reciever") {
        ...
        position_subscriber_ = this->create_subscription<geometry_msgs::msg::Pose>(
            ...
            [this](geometry_msgs::msg::Pose::SharedPtr msg) {
                ...
                target_pose1.orientation.x = -0.564;
                target_pose1.orientation.y = -0.007;
                target_pose1.orientation.z = 0.005;
                target_pose1.orientation.w = 0.826;
...
int main(int argc, char** argv)
{
    ...
    joint_group_positions[2] = -2.670;
    joint_group_positions[3] = -0.838;
    ...
    // ocm.orientation.w = 0.989;
    // ocm.orientation.x = 0.148;
    // ocm.orientation.y = -0.001;
    // ocm.orientation.z = 0.009;
    ...
    while(true){
        ...
        target_pose1.position.y = 0.746;
        target_pose1.position.z = 0.364;
        target_pose1.orientation.x = -0.564;
        target_pose1.orientation.y = -0.007;
        target_pose1.orientation.z = 0.005;
        target_pose1.orientation.w = 0.826;
        ...
        command_stream << "ros2 action send_goal -f /robotiq_2f_urcap_adapter/gripper_command "
                    ...
                    << fruit_width << ", max_effort: 50, max_speed: 0.05 }}'";
        ...
        joint_group_positions[5] = -3.142; // Modify this for UR robot
        ...
        const char*  command = "ros2 action send_goal -f /robotiq_2f_urcap_adapter/gripper_command robotiq_2f_urcap_adapter/GripperCommand '{ command: { position: 0.082, max_effort: 140, max_speed: 0.05 }}'";
